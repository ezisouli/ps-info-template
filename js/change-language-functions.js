var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Δελτίο Έκδοσης Ανεργίας",
      pageTitle: "Δελτίο Έκδοσης Ανεργίας",
      infoTitle: "Πληροφορίες για την χορήγηση Δελτίου Κάρτας Ανεργίας",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε το Δελτίο Έκδοσης Ανεργίας.",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Issue of unemployment card",
      pageTitle: "Issue of unemployment card",
      infoTitle: "Information on the Issue of unemployment card",
